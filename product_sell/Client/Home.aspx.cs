            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = !string.IsNullOrEmpty(searchQuery)
                        ? "SELECT product_id, SKU, description, price, stock, image FROM Product WHERE description LIKE @search OR SKU LIKE @search"
                        : "SELECT product_id, SKU, description, price, stock, image FROM Product";
