<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Add_Product.aspx.cs" Inherits="product_sell.Admin.Add_Product" %>
        ...
        <asp:Table runat="server" ID="tblds">
            ...
            <asp:TableRow>
              ...
              <%--      <asp:TextBox ID="txtCategory_catego" runat="server" /> --%>   
                ...
                </asp:TableCell></asp:TableRow></asp:Table><br /><asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" /><asp:Button ID="btnCancel" runat="server" Text="Cancel" />
        <p>
